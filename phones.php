...
include("webpage/MySQL/databaseConnection.php");
   ...
   $query = "SELECT * FROM products_phone";
   ...
   echo  ("<div class=\"img\">");
   echo  ("   <a target=\"_blank\" href=\"phoneInfo.php?id=$row[0]\">");
   echo  ("       <img src=\"".$row[1]."\" width=\"150\" height=\"200\"; />");
   echo  ("    </a>");
   echo  ("   <div class=\"description\"> ".$row[4]."<br /> <a href=\"phoneInfo.php?id=$row[0]\">More info</a></div>");
   echo  ("   </div>");
   echo  ("  </div>");
